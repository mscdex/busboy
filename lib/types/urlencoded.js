...
function UrlEncoded(boy, cfg) {
  ...
  this.fieldSizeLimit = bytes.parse(limits.fieldSize || '1mb');
  this.fieldNameSizeLimit = bytes.parse(limits.fieldNameSize || '100b');
  this.fieldsLimit = limits.fields || Infinity;
