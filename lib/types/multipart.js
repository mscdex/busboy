...
function Multipart(boy, cfg) {
  ...
  var fieldSizeLimit = bytes.parse(limits.fieldSize || '1MB');
  var fileSizeLimit = bytes.parse(limits.fileSize || Infinity);
  var filesLimit = limits.files || Infinity;
  var fieldsLimit = limits.fields || Infinity;
  var partsLimit = limits.parts || Infinity;
